...
public class MapManager : MonoBehaviour
{
        ...
        public List<OverlayTile> GetSurroundingTiles(Vector2Int originTile)
        {
            ...
            if (map.ContainsKey(TileToCheck))
            {
                ...
                if (Mathf.Abs(map[TileToCheck].transform.position.z - map[originTile].transform.position.z) <= 1 && !map[TileToCheck].isBlocked && !map[TileToCheck].isPlayerBlocked)
        ...
        public List<OverlayTile> GetSurroundingAtkTiles(Vector2Int originTile)
        {
            var surroundingTiles = new List<OverlayTile>();
